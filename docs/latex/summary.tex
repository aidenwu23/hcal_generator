...
\noindent This study tested whether low-energy neutron detection in the ePIC nHCal can be improved within a geometry whose total depth remains in a comparable range by redistributing absorber and scintillator 
thickness across three longitudinal segments. Geometries were evaluated with DD4hep/DDsim using a neutron G4GPS beam specification over a continuous momentum range of 0.1--2.5 GeV/c, 
and ranked with a surrogate-guided optimization loop.

\noindent The optimization landscape was found to be shallow. The final optimum was already present in the initial 150-point Latin-hypercube scan. Later Bayesian-optimization proposals 
produced geometries with similar performance, but they did not consistently outperform the best initial geometry after higher-stat confirmation runs.
...
gain of about $2\%$ relative, with somewhat larger increases in the shower-activity metrics.
