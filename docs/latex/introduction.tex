...
low-energy neutron detection can be improved by redistributing absorber and scintillator thickness along the longitudinal direction, rather than keeping the calorimeter 
...
\noindent This surrogate-based approach is useful only if the geometry response contains enough structure to distinguish genuinely better configurations from statistical 
